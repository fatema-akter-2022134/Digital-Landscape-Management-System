			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-6" id="deal">
					...
					<div class="time-counter">
						<div class="time-countdown clearfix" data-countdown="2025/06/30">
		...
		<div class="container">
			<div class="row d-flex">
				<div class="col-md-6 d-flex">
					<div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-end" style="background-image:url(images/service.png);">
						<a href="images/service.mp4" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="carousel-seasonal owl-carousel ftco-owl">
						<div class="item">
							<div class="wrap">
								<div class="seasonal img d-flex align-items-center justify-content-center" style="background-image: url(images/plant-1.jpg);">
								</div>
						...
						<div class="item">
							<div class="wrap">
								<div class="seasonal img d-flex align-items-center justify-content-center" style="background-image: url(images/plant-2.jpg);">
								</div>
								<div class="text text-center px-4">
						...
						<div class="item">
							<div class="wrap">
								<div class="seasonal img d-flex align-items-center justify-content-center" style="background-image: url(images/plant-3.jpg);">
								</div>
								<div class="text text-center px-4">
						...
						<div class="item">
							<div class="wrap">
								<div class="seasonal img d-flex align-items-center justify-content-center" style="background-image: url(images/plant-4.jpg);">
								</div>
								<div class="text text-center px-4">
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
						...
						<div class="cf-content">
							<h2><span class="counter">1205</span>+</h2>
				...
				<div class="col-md-12">
					<div class="blog-entry justify-content-end">
						<div class="carousel-project owl-carousel ftco-owl">
							...
							<div class="item">
								<div class="wrap">
									<a href="blog-single.html" class="block-20" style="background-image: url('images/project-1.jpg');">
									</a>
							...
							<div class="item">
								<div class="wrap">
									<a href="blog-single.html" class="block-20" style="background-image: url('images/project-2.jpg');">
									</a>
									<div class="text p-4 float-right d-block">
										<div class="topper d-flex align-items-center">
											<div class="one py-2 pl-3 pr-1 align-self-stretch">
										...
										<p><a href="" class="btn btn-primary">Project - Mirpur</a></p>
									</div>
								</div>
							</div>
							...
							<div class="item">
								<div class="wrap">
									<a href="blog-single.html" class="block-20" style="background-image: url('images/project-3.jpg');">
									</a>
									<div class="text p-4 float-right d-block">
										<div class="topper d-flex align-items-center">
											<div class="one py-2 pl-3 pr-1 align-self-stretch">
							...
							<div class="item">
								<div class="wrap">
									<a href="blog-single.html" class="block-20" style="background-image: url('images/project-4.jpg');">
									</a>
									<div class="text p-4 float-right d-block">
										<div class="topper d-flex align-items-center">
											<div class="one py-2 pl-3 pr-1 align-self-stretch">
					...
					<div class="services-flow">
						...
						<div class="services-2 p-4 d-flex ftco-animate">
							...
							<div class="text">
								...
								<p class="mb-0">Monthly & Yearly maintenance Packages.</p>
							</div>
						</div>
						<div class="services-2 p-4 d-flex ftco-animate">
							<div class="icon">
					...
					<div class="col-md-6 col-lg">
						<div class="ftco-footer-widget mb-4 ml-md-5">
							...
							<ul class="list-unstyled">
								<li><a href="#service" class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Landscape Design</a></li>
								<li><a href="#service" class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Planting & Garden Install</a></li>
								<li><a href="#service" class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Irrigation & Drainage</a></li>
								<li><a href="#service" class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Garden Maintenance</a></li>

								<li><a href="#service" class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Pest & Disease Control</a></li>
								<li><a href="#service" class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Sustainable Landscaping</a></li>
							</ul>
						</div>
					</div>
					<div class="col-md-6 col-lg">
						<div class="ftco-footer-widget mb-4">
							...
							<div class="block-23 mb-3">
								<ul>
									...
									<li><a href="#"><span class="icon icon-phone"></span><span class="text">01679271092</span></a></li>
									<li><a href="https://mail.google.com/"><span class="icon icon-envelope"></span><span class="text">nuranigarden@gmail.com</span></a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="ftco-footer-widget mb-4">
							...
							<div class="opening-hours">
								...
								<p class="pl-3">
									...
									<span>Saturday : 9 am to 7 pm</span>
								</p>
								<h4>Vacations:</h4>
								<p class="pl-3">
